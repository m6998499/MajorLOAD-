...
import { authOptions } from "@/lib/authSettings"; // <--- Updated import
import { checkPremium } from "@/actions/premiumActions"; // Keeping this one as it worked
    ...
    <div className="min-h-screen bg-slate-50">
      <div className="bg-slate-900 text-white py-12 px-6">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <Link href="/post-load" className="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-6 rounded-lg transition shadow-lg">
            + Post a Load
          </Link>
        </div>
      </div>
